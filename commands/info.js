  ...
  async execute (client, message, args) {
    ...
    if(data.bourse1 == 0){
      ...
      if(await AgenceManager.targetExists(data.bourse1)){
        let data2 = await AgenceManager.getOneByUserID(data.bourse1)
    ...
    if(data.bourse2 == 0){
      ...
      if(await AgenceManager.targetExists(data.bourse2)){
        let data3 = await AgenceManager.getOneByUserID(data.bourse2)
    ...
    if(data.bourse3 == 0){
      ...
      if(await AgenceManager.targetExists(data.bourse3)){
        let data4 = await AgenceManager.getOneByUserID(data.bourse3)
