...
module.exports = {
    ...
    async execute (client, message, args) {
        ...
        const tiersInfo = {
            "t1": { price: client.get("rockets/t1").price, pds: client.get("rockets/t1").pds },
            "t2": { price: client.get("rockets/t2").price, pds: client.get("rockets/t2").pds },
            "t3": { price: client.get("rockets/t3").price, pds: client.get("rockets/t3").pds },
            "t4": { price: client.get("rockets/t4").price, pds: client.get("rockets/t4").pds },
            "t5": { price: client.get("rockets/t5").price, pds: client.get("rockets/t5").pds },
            "t6": { price: client.get("rockets/t6").price, pds: client.get("rockets/t6").pds }
        }
