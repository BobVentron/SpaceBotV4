...
module.exports = {
  ...
  async execute (client, message, args) {
    ...
    const ergolTiers = {
      "t1": { quantity: client.get("rockets/t1").ergol },
      "t2": { quantity: client.get("rockets/t2").ergol },
      "t3": { quantity: client.get("rockets/t3").ergol },
      "t4": { quantity: client.get("rockets/t4").ergol },
      "t5": { quantity: client.get("rockets/t5").ergol },
      "t6": { quantity: client.get("rockets/t6").ergol }
    }
    updateMeteoAuto()
